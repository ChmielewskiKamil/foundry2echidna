...
fn deserialize_broadcast(
    broadcast_to_deserialize: &str,
) -> Result<(TransactionsList, ReceiptsList), String> {
...
mod parser_tests {
    ...
    "commit": "cba0070"
        ...
        let expected_receipt2 = Receipt {
            gas_used: "0x71658".to_string(),
            effective_gas_price: "0xb3bd".to_string(),
        };
        let transactions = TransactionsList {
            transactions: vec![expected_tx1, expected_tx2],
        };
        let receipts = ReceiptsList {
            receipts: vec![expected_receipt1, expected_receipt2],
        };
        let deserialization_result = deserialize_broadcast(broadcast_to_deserialize).unwrap();
        assert_eq!((transactions, receipts), deserialization_result);
    }
    /*//////////////////////////////////////////////////////////////
                            SERIALIZATION TESTS
    ////////////////////////////////////////////////////////////// */
